...
The static binary version of eCoin is linked against libdb5.3.
...
installed causes eCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
