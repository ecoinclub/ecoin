...
unsigned int nStakeMinAge = 8 * nOneHour; // hours as zero time weight
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "eCoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1484105017;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1484105017;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 168793; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x781c9db19e450663675107e9abd024f0cb7a970459e397c7f4e4adf1c01103ed"));
