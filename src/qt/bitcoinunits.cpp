...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("eCoins"));
    case mBTC: return QString(QObject::tr("Milli-eCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-eCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
